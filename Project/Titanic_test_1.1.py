...
# #파일 불러오기.
# df_train = pd.read_csv('../1_Titanic/Data/train.csv')
# df_test  = pd.read_csv('../1_Titanic/Data/test.csv')
...
submission = pd.read_csv('../1_Titanic/Data/sample_submission.csv')
submission.head()

prediction = model.predict(X_test)
submission['Survived'] = prediction

submission.to_csv('../1_Titanic/Data/my_first_submission.csv', index=False)